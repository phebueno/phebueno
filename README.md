## Fala! Sou Fernando, sinta-se à vontade no meu perfil

🎯 Desenvolvedor FullStack  
🎓 Bacharel em Ciências Físicas e Biomoleculares – USP  
💻 Técnico em Informática – IFSP (Campus Cubatão)  
📚 Graduando em Análise e Desenvolvimento de Sistemas – Fatec Rubens Lara  

Sou desenvolvedor FullStack com foco em aplicações modernas utilizando React, Node.js, TypeScript, dentre outras linguagens/frameworks!
Tenho experiência com modelagem de sistemas, processamento de dados e machine learning, unindo base matemática sólida com desenvolvimento de software.
